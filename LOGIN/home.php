...
.purchase--btn {
  ...
  font-size: 13px;
  font-weight: 700;
  background: linear-gradient(180deg, #363636 0%, #f51515 50%, #000000 100%);
...
<body>
    <div class="nav">
        ...
        <div class="right-links">
            ...
            $id = $_SESSION['id'];
            $query = mysqli_query($con,"SELECT*FROM gym1 WHERE id=$id");
            ...
            <a href="php/logout.php"><buttonclass="btn" >Log Out</button></a>
